import{a8 as j,c as p,r as u,j as n,a9 as C,u as T}from"./index-Dd62DqUr.js";import{u as m,M as g}from"./MDXRender-DO1pX65U.js";import{P as x}from"./Playground-CSNO60Ow.js";const{TextArea:E}=j;function A(){const t=p.c(8),[e,l]=u.useState("复制到剪贴板");let r;t[0]!==e?(r=n.jsx("div",{className:"absolute top-0 right-0 z-10",children:n.jsx(C,{text:e})}),t[0]=e,t[1]=r):r=t[1];let d;t[2]===Symbol.for("react.memo_cache_sentinel")?(d=i=>l(i.target.value),t[2]=d):d=t[2];let o;t[3]!==e?(o=n.jsx(E,{rows:3,value:e,onChange:d,placeholder:"请输入要复制的内容"}),t[3]=e,t[4]=o):o=t[4];let c;return t[5]!==r||t[6]!==o?(c=n.jsxs("div",{className:"relative",children:[r,o]}),t[5]=r,t[6]=o,t[7]=c):c=t[7],c}const N=`import { useState } from 'react'
...
`,{TextArea:B}=j;function D(){const t=p.c(9),[e,l]=u.useState("复制到剪贴板");let r;t[0]===Symbol.for("react.memo_cache_sentinel")?(r=function(b){const{copied:a,copyToClipboard:y}=b;return n.jsx("div",{className:"px-2 py-1 bg-gray-200 rounded cursor-pointer",onClick:()=>{a||y()},children:a?"已复制":"复制"})},t[0]=r):r=t[0];const d=r;let o;t[1]!==e?(o=n.jsx("div",{className:"absolute top-[1px] right-[1px] z-10",children:n.jsx(C,{text:e,children:d})}),t[1]=e,t[2]=o):o=t[2];let c;t[3]===Symbol.for("react.memo_cache_sentinel")?(c=h=>l(h.target.value),t[3]=c):c=t[3];let i;t[4]!==e?(i=n.jsx(B,{rows:3,value:e,onChange:c,placeholder:"请输入要复制的内容"}),t[4]=e,t[5]=i):i=t[5];let s;return t[6]!==o||t[7]!==i?(s=n.jsxs("div",{className:"relative",children:[o,i]}),t[6]=o,t[7]=i,t[8]=s):s=t[8],s}const R=`import { useState } from 'react'
import { Input } from 'antd'
import CopyToClipboard from '@/components/CopyToClipboard'
...
`,n.jsx(x,{code:R,title:"自定义复制按钮",description:"在文本框中输入内容，点击自定义复制按钮即可复制到剪贴板。",children:n.jsx(D,{})})]})}function z(t={}){const{wrapper:e}={...m(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(f,{...t})}):f(t)}const{TextArea:P}=j;function S(){const t=p.c(8),[e,l]=u.useState("Copy to Clipboard");let r;t[0]!==e?(r=n.jsx("div",{className:"absolute top-0 right-0 z-10",children:n.jsx(C,{text:e})}),t[0]=e,t[1]=r):r=t[1];let d;t[2]===Symbol.for("react.memo_cache_sentinel")?(d=i=>l(i.target.value),t[2]=d):d=t[2];let o;t[3]!==e?(o=n.jsx(P,{rows:3,value:e,onChange:d,placeholder:"Enter content to copy to clipboard"}),t[3]=e,t[4]=o):o=t[4];let c;return t[5]!==r||t[6]!==o?(c=n.jsxs("div",{className:"relative",children:[r,o]}),t[5]=r,t[6]=o,t[7]=c):c=t[7],c}const w=`import { useState } from 'react'
import { Input } from 'antd'
import CopyToClipboard from '@/components/CopyToClipboard'
...
export default CopyToClipboardDemo
`,{TextArea:_}=j;function F(){const t=p.c(9),[e,l]=u.useState("Copy to Clipboard");let r;t[0]===Symbol.for("react.memo_cache_sentinel")?(r=function(b){const{copied:a,copyToClipboard:y}=b;return n.jsx("div",{className:"px-2 py-1 bg-gray-200 rounded cursor-pointer",onClick:()=>{a||y()},children:a?"Copied":"Copy"})},t[0]=r):r=t[0];const d=r;let o;t[1]!==e?(o=n.jsx("div",{className:"absolute top-[1px] right-[1px] z-10",children:n.jsx(C,{text:e,children:d})}),t[1]=e,t[2]=o):o=t[2];let c;t[3]===Symbol.for("react.memo_cache_sentinel")?(c=h=>l(h.target.value),t[3]=c):c=t[3];let i;t[4]!==e?(i=n.jsx(_,{rows:3,value:e,onChange:c,placeholder:"Enter content to copy to clipboard"}),t[4]=e,t[5]=i):i=t[5];let s;return t[6]!==o||t[7]!==i?(s=n.jsxs("div",{className:"relative",children:[o,i]}),t[6]=o,t[7]=i,t[8]=s):s=t[8],s}const $=`import { useState } from 'react'
import { Input } from 'antd'
import CopyToClipboard from '@/components/CopyToClipboard'
...
`,n.jsx(x,{code:w,title:"Copy to Clipboard",description:"Enter content in the text box and click the copy button to copy to the clipboard.",children:n.jsx(S,{})}),`
`,n.jsx(e.h3,{id:"custom-copy-button",children:"Custom Copy Button"}),`
`,n.jsx(x,{code:$,title:"Custom Copy Button",description:"Enter content in the text box and click the custom copy button to copy to the clipboard.",children:n.jsx(F,{})})]})}function k(t={}){const{wrapper:e}={...m(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(v,{...t})}):v(t)}function X(){const t=p.c(2),e=T();let l;return t[0]!==e?(l=n.jsx("div",{className:"px-4 pb-4",children:n.jsx(g,{children:e==="zh"?n.jsx(z,{}):n.jsx(k,{})})}),t[0]=e,t[1]=l):l=t[1],l}export{X as default};
