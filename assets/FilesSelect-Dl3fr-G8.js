import{c as m,r as a,j as e,a as T}from"./index-sPAEccKG.js";import{u as j,M as g}from"./MDXRender-BZarAgbB.js";import{P as p}from"./Playground-CL5umANt.js";import{F as y}from"./FilesUploadDrawer-eKFMY6t7.js";import{F as x}from"./FilesSelect-D7M6weG2.js";import{J as f}from"./JsonView-BGQFDy7V.js";import"./JsonEditor-BoNEgsyL.js";import"./CodeEditor-iUaEkS4k.js";import"./JsonRender-Ct9XYPVU.js";import"./use-undo.m-Du7Ehewq.js";function L(){const n=m.c(6),[t,l]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[s,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),l(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let h;return n[3]!==t||n[4]!==s?(h=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:s,setOpen:l})]}),n[3]=t,n[4]=s,n[5]=h):h=n[5],h}const w=`import { useState } from 'react'
...
`,e.jsx(p,{code:w,title:"上传文件/文件夹",description:"选择之后直接上传文件/文件夹。",children:e.jsx(L,{})})]})}function B(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(S,{...n})}):S(n)}function U(){const n=m.c(6),[t,l]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[s,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),l(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let h;return n[3]!==t||n[4]!==s?(h=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:s,setOpen:l})]}),n[3]=t,n[4]=s,n[5]=h):h=n[5],h}const J=`import { useState } from 'react'
import FilesUploadDrawer from '@/components/FilesUploadDrawer'
import FilesSelect from '@/components/FilesSelect'
import type { FileItemType } from '@/types/files'
...
`,e.jsx(p,{code:J,title:"Upload Files/Folders",description:"Select files/folders, then upload them directly.",children:e.jsx(U,{})})]})}function R(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(u,{...n})}):u(n)}function Q(){const n=m.c(2),t=T();let l;return n[0]!==t?(l=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(g,{children:t==="zh"?e.jsx(B,{}):e.jsx(R,{})})}),n[0]=t,n[1]=l):l=n[1],l}export{Q as default};
