...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"markdown/md-demo-page",children:"MdRender 演示示例"})})]})}function x(d={}){const{wrapper:n}={...s(),...d.components};return n?e.jsx(n,{...d,children:e.jsx(l,{...d})}):l(d)}function p(){const d=i.c(2),n=t();let r;return d[0]!==n?(r=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(h,{children:n==="zh"?e.jsx(o,{}):e.jsx(x,{})})}),d[0]=n,d[1]=r):r=d[1],r}export{p as default};
