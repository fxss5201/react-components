import{c as T,r as f,j as e,u as L}from"./index-CrVpgTXP.js";import{u as w,M as O}from"./MDXRender-Cr4xr3VV.js";import{P as S}from"./Playground-DtAykHKn.js";import{F as U}from"./FilesUploadDrawer-DCORy1t1.js";import{F as I}from"./FilesSelect-CjsmZWvK.js";import{J as g}from"./JsonView-CuGsheLP.js";import"./JsonEditor-C9rTAIVU.js";import"./CodeEditor-BjRa_2mt.js";import"./JsonRender-31iHI8gg.js";import"./use-undo.m-XjMNnjBE.js";function _(){const s=T.c(13),[t,h]=f.useState(!1);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],s[0]=r):r=s[0];const[m,u]=f.useState(r);let i;s[1]===Symbol.for("react.memo_cache_sentinel")?(i=[],s[1]=i):i=s[1];const[x,j]=f.useState(i);let o;s[2]===Symbol.for("react.memo_cache_sentinel")?(o=p=>{u(p),h(!0)},s[2]=o):o=s[2];const F=o;let c;s[3]===Symbol.for("react.memo_cache_sentinel")?(c=p=>{console.log("success",p),j(p)},s[3]=c):c=s[3];const y=c;let a;s[4]===Symbol.for("react.memo_cache_sentinel")?(a=e.jsx(I,{targetType:"list",isUpload:!0,onSelect:F}),s[4]=a):a=s[4];let n;s[5]!==t||s[6]!==m?(n=e.jsx(U,{targetType:"list",open:t,list:m,setOpen:h,onSuccess:y}),s[5]=t,s[6]=m,s[7]=n):n=s[7];let l;s[8]!==x?(l=e.jsx(g,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:x}),s[8]=x,s[9]=l):l=s[9];let d;return s[10]!==n||s[11]!==l?(d=e.jsxs("div",{className:"px-4 pb-4",children:[a,n,l]}),s[10]=n,s[11]=l,s[12]=d):d=s[12],d}const v=`import { useState } from 'react'
