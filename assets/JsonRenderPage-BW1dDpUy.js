import{b as a,j as e}from"./@uiw/react-codemirror-dimZJgSu.js";import{c as l,X as h,a as u}from"./index-DSuvab2R.js";import{M as g}from"./MDXRender-Di5ktpbL.js";import{P as i}from"./Playground-DMhcnxEs.js";import{J as j}from"./JsonRender-C52GdcUk.js";import{u as x}from"./@mdx-js/react-BwGmxI0N.js";import"./react-syntax-highlighter-DW6ulm9l.js";import"./markdown-plugins-CqPL4kxN.js";import"./react-markdown-U0gPFawi.js";import"./UpOutlined-DGt0aSTq.js";function C(){const r=l.c(3),[n,o]=a.useState(!0);let s;r[0]===Symbol.for("react.memo_cache_sentinel")?(s=c=>o(c.target.checked),r[0]=s):s=r[0];let t;return r[1]!==n?(t=e.jsxs(e.Fragment,{children:[e.jsx(h,{checked:n,onChange:s,children:"启用代码复制"}),e.jsx(j,{enableCopy:n,className:"mt-2!",children:`{
    "name": "张三",
    "age": 18,
    "gender": "男"
...
export default JsonRender
`})})]})}function k(r={}){const{wrapper:n}={...x(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(b,{...r})}):b(r)}function I(){const r=l.c(2),n=u();let o;return r[0]!==n?(o=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(g,{children:n==="zh"?e.jsx(J,{}):e.jsx(k,{})})}),r[0]=n,r[1]=o):o=r[1],o}export{I as default};
