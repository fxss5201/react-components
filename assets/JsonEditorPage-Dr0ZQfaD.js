import{b as p,j as e}from"./@uiw/react-codemirror-dimZJgSu.js";import{c as E,X as u,a as N}from"./index-DSuvab2R.js";import{M as w}from"./MDXRender-Di5ktpbL.js";import{P as g}from"./Playground-DMhcnxEs.js";import{J as y}from"./JsonEditor-Mp629PcR.js";import{u as S}from"./@mdx-js/react-BwGmxI0N.js";import"./react-syntax-highlighter-DW6ulm9l.js";import"./markdown-plugins-CqPL4kxN.js";import"./react-markdown-U0gPFawi.js";import"./UpOutlined-DGt0aSTq.js";import"./CodeEditor-CQiUGbj3.js";import"./JsonRender-C52GdcUk.js";import"./use-undo.m-CQg1LMRB.js";import"./index-CNPncdW_.js";function O(){const t=E.c(14),[n,j]=p.useState(!0),[o,f]=p.useState(!0);let r;t[0]===Symbol.for("react.memo_cache_sentinel")?(r=d=>j(d.target.checked),t[0]=r):r=t[0];let h;t[1]!==n?(h=e.jsx(u,{checked:n,onChange:r,children:"启用自定义复制代码功能"}),t[1]=n,t[2]=h):h=t[2];let a;t[3]===Symbol.for("react.memo_cache_sentinel")?(a=d=>f(d.target.checked),t[3]=a):a=t[3];let s;t[4]!==o?(s=e.jsx(u,{checked:o,onChange:a,children:"启用搜索"}),t[4]=o,t[5]=s):s=t[5];let i;t[6]===Symbol.for("react.memo_cache_sentinel")?(i={name:"张三",age:18,sex:"男",books:[{name:"《三国演义》",author:"罗贯中"},{name:"《水浒传》",author:"施耐庵"},{name:"《西游记》",author:"吴承恩"},{name:"《红楼梦》",author:"曹雪芹"}],toys:[{name:"玩具1",price:100},{name:"玩具2",price:200},{name:"玩具3",price:300},{name:"玩具4",price:400},{name:"玩具5",price:500},{name:"玩具6",price:600}]},t[6]=i):i=t[6];let c;t[7]!==n||t[8]!==o?(c=e.jsx(y,{viewOnly:!0,enableCopy:n,enableSearch:o,className:"mt-2",jsonClassName:"max-h-[50vh] overflow-auto",children:i}),t[7]=n,t[8]=o,t[9]=c):c=t[9];let l;return t[10]!==h||t[11]!==s||t[12]!==c?(l=e.jsxs(e.Fragment,{children:[h,s,c]}),t[10]=h,t[11]=s,t[12]=c,t[13]=l):l=t[13],l}const D=`import { useState } from 'react'
...
export default JsonView
`})})]})}function T(t={}){const{wrapper:n}={...S(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(k,{...t})}):k(t)}function re(){const t=E.c(2),n=N();let j;return t[0]!==n?(j=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(w,{children:n==="zh"?e.jsx(P,{}):e.jsx(T,{})})}),t[0]=n,t[1]=j):j=t[1],j}export{re as default};
