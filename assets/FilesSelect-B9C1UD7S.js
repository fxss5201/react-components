import{c as m,r as a,j as e,u as T}from"./index-Dd62DqUr.js";import{u as j,M as g}from"./MDXRender-DO1pX65U.js";import{P as p}from"./Playground-CSNO60Ow.js";import{F as x,a as y}from"./FilesSelect-CMAjTOmw.js";import{J as f}from"./JsonView-DqiHYVOU.js";import"./JsonEditor-DSvVl0IO.js";import"./CodeEditor-BFvI7CoV.js";import"./JsonRender-3M2gVJ7Q.js";import"./use-undo.m-Bk1lAah2.js";function I(){const n=m.c(6),[t,s]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[l,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),s(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let h;return n[3]!==t||n[4]!==l?(h=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:l,setOpen:s})]}),n[3]=t,n[4]=l,n[5]=h):h=n[5],h}const L=`import { useState } from 'react'
...
`,e.jsx(p,{code:J,title:"Upload Files/Folders",description:"Select files/folders, then upload them directly.",children:e.jsx(U,{})})]})}function R(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(S,{...n})}):S(n)}function K(){const n=m.c(2),t=T();let s;return n[0]!==t?(s=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(g,{children:t==="zh"?e.jsx(B,{}):e.jsx(R,{})})}),n[0]=t,n[1]=s):s=n[1],s}export{K as default};
