import{c as l,r as i,j as e,a6 as h,u}from"./index-CrVpgTXP.js";import{u as j,M as g}from"./MDXRender-Cr4xr3VV.js";import{P as a}from"./Playground-DtAykHKn.js";import{J as x}from"./JsonRender-31iHI8gg.js";function C(){const s=l.c(3),[n,d]=i.useState(!0);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=c=>d(c.target.checked),s[0]=r):r=s[0];let t;return s[1]!==n?(t=e.jsxs(e.Fragment,{children:[e.jsx(h,{checked:n,onChange:r,children:"启用代码复制"}),e.jsx(x,{enableCopy:n,className:"mt-2!",children:`{
    "name": "张三",
    "age": 18,
    "gender": "男"
