import{b as a,j as e}from"./@uiw/react-codemirror-dimZJgSu.js";import{c as h,a as T}from"./index-DSuvab2R.js";import{M as g}from"./MDXRender-Di5ktpbL.js";import{P as p}from"./Playground-DMhcnxEs.js";import{F as y}from"./FilesUploadDrawer-ETGFCzDD.js";import{F as x}from"./FilesSelect-BSt7RMid.js";import{J as f}from"./JsonView-Bxl7ZjAE.js";import{u as j}from"./@mdx-js/react-BwGmxI0N.js";import"./react-syntax-highlighter-DW6ulm9l.js";import"./markdown-plugins-CqPL4kxN.js";import"./react-markdown-U0gPFawi.js";import"./UpOutlined-DGt0aSTq.js";import"./index-cVt1WAU-.js";import"./index-CdfFNr5u.js";import"./JsonEditor-Mp629PcR.js";import"./CodeEditor-CQiUGbj3.js";import"./JsonRender-C52GdcUk.js";import"./use-undo.m-CQg1LMRB.js";import"./index-CNPncdW_.js";function L(){const n=h.c(6),[t,l]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[s,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),l(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let m;return n[3]!==t||n[4]!==s?(m=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:s,setOpen:l})]}),n[3]=t,n[4]=s,n[5]=m):m=n[5],m}const w=`import { useState } from 'react'
...
`,e.jsx(p,{code:J,title:"Upload Files/Folders",description:"Select files/folders, then upload them directly.",children:e.jsx(U,{})})]})}function R(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(u,{...n})}):u(n)}function re(){const n=h.c(2),t=T();let l;return n[0]!==t?(l=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(g,{children:t==="zh"?e.jsx(B,{}):e.jsx(R,{})})}),n[0]=t,n[1]=l):l=n[1],l}export{re as default};
