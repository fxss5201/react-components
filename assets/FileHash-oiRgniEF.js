import{b as g,j as t}from"./@uiw/react-codemirror-dimZJgSu.js";import{c as D,a as C}from"./index-DSuvab2R.js";import{M as E}from"./MDXRender-Di5ktpbL.js";import{P as L}from"./Playground-DMhcnxEs.js";import{D as N}from"./DropElement-Bs7d6bbg.js";import{J as b}from"./JsonView-Bxl7ZjAE.js";import{S as P}from"./index-D1hXD0tA.js";import{S as _}from"./index-CNPncdW_.js";import{u as A}from"./@mdx-js/react-BwGmxI0N.js";import"./react-syntax-highlighter-DW6ulm9l.js";import"./markdown-plugins-CqPL4kxN.js";import"./react-markdown-U0gPFawi.js";import"./UpOutlined-DGt0aSTq.js";import"./useEffectWithTarget-DNNn9MTz.js";import"./isBrowser-DHn9PsMo.js";import"./JsonEditor-Mp629PcR.js";import"./CodeEditor-CQiUGbj3.js";import"./JsonRender-C52GdcUk.js";import"./use-undo.m-CQg1LMRB.js";import"./List-awzUhNmJ.js";async function B(e,n="SHA-256"){const i=await e.arrayBuffer(),S=await window.crypto.subtle.digest(n,i);return Array.from(new Uint8Array(S)).map(h=>h.toString(16).padStart(2,"0")).join("")}function J(){const e=D.c(19);let n;e[0]===Symbol.for("react.memo_cache_sentinel")?(n=[],e[0]=n):n=e[0];const[i,S]=g.useState(n),[s,F]=g.useState("SHA-256"),[h,j]=g.useState(!1);let a;if(e[1]!==s){a=async function(x){j(!0),S(await v(x)),j(!1)};async function v(y){const x=[];for(let H=0;H<y.length;H++){const m=y[H],T=await B(m.file,s);x.push({type:m.type,file:m.file,name:m.name,filePath:m.filePath,folderPath:m.folderPath,hashHex:T})}return x}e[1]=s,e[2]=a}else a=e[2];let f;e[3]===Symbol.for("react.memo_cache_sentinel")?(f=t.jsx("div",{children:"加密算法："}),e[3]=f):f=e[3];let d;e[4]===Symbol.for("react.memo_cache_sentinel")?(d=["SHA-1","SHA-256","SHA-384","SHA-512"].map(M),e[4]=d):d=e[4];let l;e[5]!==s?(l=t.jsxs("div",{className:"flex items-center",children:[f,t.jsx(P,{value:s,onChange:F,options:d,className:"w-30"})]}),e[5]=s,e[6]=l):l=e[6];let p;e[7]===Symbol.for("react.memo_cache_sentinel")?(p=t.jsxs("div",{className:"text-center",children:[t.jsx("div",{className:"text-2xl",children:"文件哈希计算器"}),t.jsx("div",{className:"text-sm mt-4",children:"拖拽文件/文件夹到此处，即可计算文件的哈希值。"})]}),e[7]=p):p=e[7];let o;e[8]!==a?(o=t.jsx(N,{targetType:"list",isIgnoreFolder:!0,onSelect:a,className:"mt-4",children:p}),e[8]=a,e[9]=o):o=e[9];let r;e[10]!==i?(r=t.jsx(b,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:i}),e[10]=i,e[11]=r):r=e[11];let c;e[12]!==h||e[13]!==r?(c=t.jsx(_,{spinning:h,children:r}),e[12]=h,e[13]=r,e[14]=c):c=e[14];let u;return e[15]!==l||e[16]!==o||e[17]!==c?(u=t.jsxs(t.Fragment,{children:[l,o,c]}),e[15]=l,e[16]=o,e[17]=c,e[18]=u):u=e[18],u}function M(e){return{value:e,label:e}}const V=`import { useState } from 'react'
