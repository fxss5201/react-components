import{c as h,r as j,j as e,a as F}from"./index-sPAEccKG.js";import{u as i,M as D}from"./MDXRender-BZarAgbB.js";import{P as p}from"./Playground-CL5umANt.js";import{F as m}from"./FilesDropSelect-uTwU63Xo.js";import{J as f}from"./JsonView-BGQFDy7V.js";import"./DropElement-D51bjCMN.js";import"./useEffectWithTarget-BuQwNup2.js";import"./FilesSelect-D7M6weG2.js";import"./JsonEditor-BoNEgsyL.js";import"./CodeEditor-iUaEkS4k.js";import"./JsonRender-Ct9XYPVU.js";import"./use-undo.m-Du7Ehewq.js";function S(){const t=h.c(4);let n;t[0]===Symbol.for("react.memo_cache_sentinel")?(n=[],t[0]=n):n=t[0];const[s,c]=j.useState(n);let l;if(t[1]===Symbol.for("react.memo_cache_sentinel")){const d=function(o){c(o)};l=e.jsx(m,{onSelect:d}),t[1]=l}else l=t[1];let r;return t[2]!==s?(r=e.jsxs(e.Fragment,{children:[l,e.jsx(f,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:s})]}),t[2]=s,t[3]=r):r=t[3],r}const y=`import { useState } from 'react'
