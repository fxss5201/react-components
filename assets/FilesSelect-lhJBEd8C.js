import{b as a,j as e}from"./@uiw/react-codemirror-dimZJgSu.js";import{c as h,a as T}from"./index-Cu686E0i.js";import{M as g}from"./MDXRender-BBvYu2-Q.js";import{P as p}from"./Playground-5R6frOv8.js";import{F as y}from"./FilesUploadDrawer-g-cQCxDu.js";import{F as x}from"./FilesSelect-ltMS2_C1.js";import{J as f}from"./JsonView-WauxlayO.js";import{u as j}from"./@mdx-js/react-BwGmxI0N.js";import"./react-syntax-highlighter-DW6ulm9l.js";import"./markdown-plugins-CqPL4kxN.js";import"./react-markdown-U0gPFawi.js";import"./use-immer.module--qy1-jU-.js";import"./index-Cd_Dtwn5.js";import"./progress-BsJPGnFI.js";import"./index-oD-Nz_1Z.js";import"./JsonEditor-B_67iV4Q.js";import"./CodeEditor-CbU2qp3m.js";import"./JsonRender-BAp0alGJ.js";import"./use-undo.m-DcC4Rq-4.js";import"./index-D71U_GTy.js";function L(){const n=h.c(6),[t,l]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[s,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),l(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let m;return n[3]!==t||n[4]!==s?(m=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:s,setOpen:l})]}),n[3]=t,n[4]=s,n[5]=m):m=n[5],m}const w=`import { useState } from 'react'
...
`,e.jsx(p,{code:w,title:"上传文件/文件夹",description:"选择之后直接上传文件/文件夹。",children:e.jsx(L,{})})]})}function B(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(S,{...n})}):S(n)}function U(){const n=h.c(6),[t,l]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[s,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),l(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let m;return n[3]!==t||n[4]!==s?(m=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:s,setOpen:l})]}),n[3]=t,n[4]=s,n[5]=m):m=n[5],m}const J=`import { useState } from 'react'
import FilesUploadDrawer from '@/components/FilesUploadDrawer'
import FilesSelect from '@/components/FilesSelect'
import type { FileItemType } from '@/types/files'
...
`,e.jsx(p,{code:J,title:"Upload Files/Folders",description:"Select files/folders, then upload them directly.",children:e.jsx(U,{})})]})}function R(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(u,{...n})}):u(n)}function oe(){const n=h.c(2),t=T();let l;return n[0]!==t?(l=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(g,{children:t==="zh"?e.jsx(B,{}):e.jsx(R,{})})}),n[0]=t,n[1]=l):l=n[1],l}export{oe as default};
