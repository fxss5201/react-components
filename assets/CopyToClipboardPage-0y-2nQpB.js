import{c as h,r as j,j as n,av as p,u as b}from"./index-BFMmcQtt.js";import{u as l,P as u,M as C}from"./Playground-piR_5RSu.js";import{I as m}from"./index-Dh3V20RN.js";import"./index-BJzs7o3g.js";import"./UpOutlined-BB8b5Q6d.js";import"./useVariants-BihWoGkc.js";import"./EyeOutlined-Dod80o9I.js";const{TextArea:y}=m;function f(){const t=h.c(8),[e,i]=j.useState("复制到剪贴板");let r;t[0]!==e?(r=n.jsx("div",{className:"absolute top-0 right-0 z-10",children:n.jsx(p,{text:e})}),t[0]=e,t[1]=r):r=t[1];let c;t[2]===Symbol.for("react.memo_cache_sentinel")?(c=s=>i(s.target.value),t[2]=c):c=t[2];let d;t[3]!==e?(d=n.jsx(y,{rows:3,value:e,onChange:c,placeholder:"请输入要复制的内容"}),t[3]=e,t[4]=d):d=t[4];let o;return t[5]!==r||t[6]!==d?(o=n.jsxs("div",{className:"relative",children:[r,d]}),t[5]=r,t[6]=d,t[7]=o):o=t[7],o}const g=`import { useState } from 'react'
...
`,n.jsx(u,{code:g,title:"复制到剪贴板",description:"在文本框中输入内容，点击复制按钮即可复制到剪贴板。",children:n.jsx(f,{})})]})}function v(t={}){const{wrapper:e}={...l(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(a,{...t})}):a(t)}const{TextArea:T}=m;function E(){const t=h.c(8),[e,i]=j.useState("Copy to Clipboard");let r;t[0]!==e?(r=n.jsx("div",{className:"absolute top-0 right-0 z-10",children:n.jsx(p,{text:e})}),t[0]=e,t[1]=r):r=t[1];let c;t[2]===Symbol.for("react.memo_cache_sentinel")?(c=s=>i(s.target.value),t[2]=c):c=t[2];let d;t[3]!==e?(d=n.jsx(T,{rows:3,value:e,onChange:c,placeholder:"Enter content to copy to clipboard"}),t[3]=e,t[4]=d):d=t[4];let o;return t[5]!==r||t[6]!==d?(o=n.jsxs("div",{className:"relative",children:[r,d]}),t[5]=r,t[6]=d,t[7]=o):o=t[7],o}const N=`import { useState } from 'react'
import { Input } from 'antd'
import CopyToClipboard from '../../../components/CopyToClipboard'
...
`,n.jsx(u,{code:N,title:"Copy to Clipboard",description:"Enter content in the text box and click the copy button to copy to the clipboard.",children:n.jsx(E,{})})]})}function R(t={}){const{wrapper:e}={...l(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(x,{...t})}):x(t)}function k(){const t=h.c(2),e=b();let i;return t[0]!==e?(i=n.jsx("div",{className:"px-4 pb-4",children:n.jsx(C,{children:e==="zh"?n.jsx(v,{}):n.jsx(R,{})})}),t[0]=e,t[1]=i):i=t[1],i}export{k as default};
