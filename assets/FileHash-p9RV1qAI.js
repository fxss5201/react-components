import{c as T,r as g,j as t,a4 as I,a5 as N,u as C}from"./index-CIGk9ZnJ.js";import{u as A,M as E}from"./MDXRender-D9plMhjo.js";import{P as b}from"./Playground-BNwi_gF4.js";import{D as P}from"./DropElement-CJ9Fa8HU.js";import{J as _}from"./JsonView-C7Lw0-dA.js";import"./useEffectWithTarget-5iqEwISW.js";import"./JsonEditor-DY1ovXTU.js";import"./CodeEditor-DvkJBADL.js";import"./JsonRender-COIaxv0w.js";import"./use-undo.m-B9bhx3J_.js";async function B(e,n="SHA-256"){const i=await e.arrayBuffer(),S=await window.crypto.subtle.digest(n,i);return Array.from(new Uint8Array(S)).map(h=>h.toString(16).padStart(2,"0")).join("")}function J(){const e=T.c(19);let n;e[0]===Symbol.for("react.memo_cache_sentinel")?(n=[],e[0]=n):n=e[0];const[i,S]=g.useState(n),[s,j]=g.useState("SHA-256"),[h,F]=g.useState(!1);let a;if(e[1]!==s){a=async function(x){F(!0),S(await D(x)),F(!1)};async function D(y){const x=[];for(let H=0;H<y.length;H++){const m=y[H],v=await B(m.file,s);x.push({type:m.type,file:m.file,name:m.name,filePath:m.filePath,folderPath:m.folderPath,hashHex:v})}return x}e[1]=s,e[2]=a}else a=e[2];let f;e[3]===Symbol.for("react.memo_cache_sentinel")?(f=t.jsx("div",{children:"加密算法："}),e[3]=f):f=e[3];let d;e[4]===Symbol.for("react.memo_cache_sentinel")?(d=["SHA-1","SHA-256","SHA-384","SHA-512"].map(M),e[4]=d):d=e[4];let l;e[5]!==s?(l=t.jsxs("div",{className:"flex items-center",children:[f,t.jsx(I,{value:s,onChange:j,options:d,className:"w-30"})]}),e[5]=s,e[6]=l):l=e[6];let p;e[7]===Symbol.for("react.memo_cache_sentinel")?(p=t.jsxs("div",{className:"text-center",children:[t.jsx("div",{className:"text-2xl",children:"文件哈希计算器"}),t.jsx("div",{className:"text-sm mt-4",children:"拖拽文件/文件夹到此处，即可计算文件的哈希值。"})]}),e[7]=p):p=e[7];let o;e[8]!==a?(o=t.jsx(P,{targetType:"list",onDrop:a,className:"mt-4",children:p}),e[8]=a,e[9]=o):o=e[9];let r;e[10]!==i?(r=t.jsx(_,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:i}),e[10]=i,e[11]=r):r=e[11];let c;e[12]!==h||e[13]!==r?(c=t.jsx(N,{spinning:h,children:r}),e[12]=h,e[13]=r,e[14]=c):c=e[14];let u;return e[15]!==l||e[16]!==o||e[17]!==c?(u=t.jsxs(t.Fragment,{children:[l,o,c]}),e[15]=l,e[16]=o,e[17]=c,e[18]=u):u=e[18],u}function M(e){return{value:e,label:e}}const V=`import { useState } from 'react'
...
`,t.jsx(b,{code:V,title:"文件哈希",description:"拖拽文件/文件夹到此处，即可计算文件的哈希值（支持递归计算文件夹下所有文件的哈希值， 文件哈希值可以作为文件内容的唯一标识）。",children:t.jsx(J,{})})]})}function $(e={}){const{wrapper:n}={...A(),...e.components};return n?t.jsx(n,{...e,children:t.jsx(w,{...e})}):w(e)}function X(){const e=T.c(19);let n;e[0]===Symbol.for("react.memo_cache_sentinel")?(n=[],e[0]=n):n=e[0];const[i,S]=g.useState(n),[s,j]=g.useState("SHA-256"),[h,F]=g.useState(!1);let a;if(e[1]!==s){a=async function(x){F(!0),S(await D(x)),F(!1)};async function D(y){const x=[];for(let H=0;H<y.length;H++){const m=y[H],v=await B(m.file,s);x.push({type:m.type,file:m.file,name:m.name,filePath:m.filePath,folderPath:m.folderPath,hashHex:v})}return x}e[1]=s,e[2]=a}else a=e[2];let f;e[3]===Symbol.for("react.memo_cache_sentinel")?(f=t.jsx("div",{children:"encryption algorithm: "}),e[3]=f):f=e[3];let d;e[4]===Symbol.for("react.memo_cache_sentinel")?(d=["SHA-1","SHA-256","SHA-384","SHA-512"].map(R),e[4]=d):d=e[4];let l;e[5]!==s?(l=t.jsxs("div",{className:"flex items-center",children:[f,t.jsx(I,{value:s,onChange:j,options:d,className:"w-30"})]}),e[5]=s,e[6]=l):l=e[6];let p;e[7]===Symbol.for("react.memo_cache_sentinel")?(p=t.jsxs("div",{className:"text-center",children:[t.jsx("div",{className:"text-2xl",children:"File Hash Calculator"}),t.jsx("div",{className:"text-sm mt-4",children:"Drag files/folders to here, and you can calculate the hash value of the files."})]}),e[7]=p):p=e[7];let o;e[8]!==a?(o=t.jsx(P,{targetType:"list",onDrop:a,className:"mt-4",children:p}),e[8]=a,e[9]=o):o=e[9];let r;e[10]!==i?(r=t.jsx(_,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:i}),e[10]=i,e[11]=r):r=e[11];let c;e[12]!==h||e[13]!==r?(c=t.jsx(N,{spinning:h,children:r}),e[12]=h,e[13]=r,e[14]=c):c=e[14];let u;return e[15]!==l||e[16]!==o||e[17]!==c?(u=t.jsxs(t.Fragment,{children:[l,o,c]}),e[15]=l,e[16]=o,e[17]=c,e[18]=u):u=e[18],u}function R(e){return{value:e,label:e}}const U=`import { useState } from 'react'
import { Select, Spin } from 'antd'
import DropElement from '@/components/DropElement'
import type { FileTreeFileItem, FileItemType } from '@/types/files'
import JsonView from '@/components/JsonView'
...
export default FileHashDemo
`;function L(e){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",pre:"pre",ul:"ul",...A(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(n.h1,{id:"filehash",children:"FileHash"}),`
