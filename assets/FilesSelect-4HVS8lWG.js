import{c as m,r as a,j as e,u as T}from"./index-CrVpgTXP.js";import{u as j,M as g}from"./MDXRender-Cr4xr3VV.js";import{P as p}from"./Playground-DtAykHKn.js";import{F as y}from"./FilesUploadDrawer-DCORy1t1.js";import{F as x}from"./FilesSelect-CjsmZWvK.js";import{J as f}from"./JsonView-CuGsheLP.js";import"./JsonEditor-C9rTAIVU.js";import"./CodeEditor-BjRa_2mt.js";import"./JsonRender-31iHI8gg.js";import"./use-undo.m-XjMNnjBE.js";function I(){const n=m.c(6),[t,s]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[l,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),s(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let h;return n[3]!==t||n[4]!==l?(h=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:l,setOpen:s})]}),n[3]=t,n[4]=l,n[5]=h):h=n[5],h}const L=`import { useState } from 'react'
...
`;function w(){const n=m.c(4);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=[],n[0]=t):t=n[0];const[s,r]=a.useState(t);let l;if(n[1]===Symbol.for("react.memo_cache_sentinel")){const o=function(c){r(c)};l=e.jsx(x,{targetType:"list",onSelect:o,className:"mt-4"}),n[1]=l}else l=n[1];let i;return n[2]!==s?(i=e.jsxs(e.Fragment,{children:[l,e.jsx(f,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:s})]}),n[2]=s,n[3]=i):i=n[3],i}const D=`import { useState } from 'react'
import FilesSelect from '@/components/FilesSelect'
...
`;function N(){const n=m.c(4);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=[],n[0]=t):t=n[0];const[s,r]=a.useState(t);let l;if(n[1]===Symbol.for("react.memo_cache_sentinel")){const o=function(c){r(c)};l=e.jsx(x,{targetType:"tree",onSelect:o,className:"mt-4"}),n[1]=l}else l=n[1];let i;return n[2]!==s?(i=e.jsxs(e.Fragment,{children:[l,e.jsx(f,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:s})]}),n[2]=s,n[3]=i):i=n[3],i}const b=`import { useState } from 'react'
...
`;function _(){const n=m.c(4);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=[],n[0]=t):t=n[0];const[s,r]=a.useState(t);let l;if(n[1]===Symbol.for("react.memo_cache_sentinel")){const o=function(c){r(c)};l=e.jsx(x,{targetType:"list",isIgnoreFolder:!0,onSelect:o,className:"mt-4"}),n[1]=l}else l=n[1];let i;return n[2]!==s?(i=e.jsxs(e.Fragment,{children:[l,e.jsx(f,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:s})]}),n[2]=s,n[3]=i):i=n[3],i}const E=`import { useState } from 'react'
import FilesSelect from '@/components/FilesSelect'
import type { FileTreeFileItem } from '@/types/files'
import JsonView from '@/components/JsonView'
...
`,e.jsx(p,{code:L,title:"上传文件/文件夹",description:"选择之后直接上传文件/文件夹。",children:e.jsx(I,{})})]})}function B(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(u,{...n})}):u(n)}function U(){const n=m.c(6),[t,s]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[l,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),s(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let h;return n[3]!==t||n[4]!==l?(h=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:l,setOpen:s})]}),n[3]=t,n[4]=l,n[5]=h):h=n[5],h}const J=`import { useState } from 'react'
import FilesUploadDrawer from '@/components/FilesUploadDrawer'
import FilesSelect from '@/components/FilesSelect'
import type { FileItemType } from '@/types/files'
...
export default FilesListUpload
`;function V(){const n=m.c(4);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=[],n[0]=t):t=n[0];const[s,r]=a.useState(t);let l;if(n[1]===Symbol.for("react.memo_cache_sentinel")){const o=function(c){r(c)};l=e.jsx(x,{targetType:"list",onSelect:o,className:"mt-4"}),n[1]=l}else l=n[1];let i;return n[2]!==s?(i=e.jsxs(e.Fragment,{children:[l,e.jsx(f,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:s})]}),n[2]=s,n[3]=i):i=n[3],i}const v=`import { useState } from 'react'
import FilesSelect from '@/components/FilesSelect'
import type { FileTreeFileItem } from '@/types/files'
import JsonView from '@/components/JsonView'
...
export default FileSelectList
`;function C(){const n=m.c(4);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=[],n[0]=t):t=n[0];const[s,r]=a.useState(t);let l;if(n[1]===Symbol.for("react.memo_cache_sentinel")){const o=function(c){r(c)};l=e.jsx(x,{targetType:"tree",onSelect:o,className:"mt-4"}),n[1]=l}else l=n[1];let i;return n[2]!==s?(i=e.jsxs(e.Fragment,{children:[l,e.jsx(f,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:s})]}),n[2]=s,n[3]=i):i=n[3],i}const P=`import { useState } from 'react'
import FilesSelect, { type FileTreeItem } from '@/components/FilesSelect'
import JsonView from '@/components/JsonView'
...
export default FileSelectTree
`;function O(){const n=m.c(4);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=[],n[0]=t):t=n[0];const[s,r]=a.useState(t);let l;if(n[1]===Symbol.for("react.memo_cache_sentinel")){const o=function(c){r(c)};l=e.jsx(x,{targetType:"list",isIgnoreFolder:!0,onSelect:o,className:"mt-4"}),n[1]=l}else l=n[1];let i;return n[2]!==s?(i=e.jsxs(e.Fragment,{children:[l,e.jsx(f,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:s})]}),n[2]=s,n[3]=i):i=n[3],i}const A=`import { useState } from 'react'
import FilesSelect from '@/components/FilesSelect'
import type { FileTreeFileItem } from '@/types/files'
import JsonView from '@/components/JsonView'
...
`,e.jsx(p,{code:A,title:"Ignore Folders in File List",description:"Select file list, ignore folders.",children:e.jsx(O,{})}),`
`,e.jsx(t.h3,{id:"file-tree",children:"File Tree"}),`
`,e.jsx(p,{code:P,title:"File Tree",description:"Select file tree.",children:e.jsx(C,{})}),`
`,e.jsx(t.h3,{id:"upload-filesfolders",children:"Upload Files/Folders"}),`
`,e.jsx(p,{code:J,title:"Upload Files/Folders",description:"Select files/folders, then upload them directly.",children:e.jsx(U,{})})]})}function R(n={}){const{wrapper:t}={...j(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(S,{...n})}):S(n)}function Q(){const n=m.c(2),t=T();let s;return n[0]!==t?(s=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(g,{children:t==="zh"?e.jsx(B,{}):e.jsx(R,{})})}),n[0]=t,n[1]=s):s=n[1],s}export{Q as default};
