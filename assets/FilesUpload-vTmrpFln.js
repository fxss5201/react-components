import{c as T,r as f,j as e,u as L}from"./index-Dd62DqUr.js";import{u as w,M as O}from"./MDXRender-DO1pX65U.js";import{P as S}from"./Playground-CSNO60Ow.js";import{F as U,a as I}from"./FilesSelect-CMAjTOmw.js";import{J as g}from"./JsonView-DqiHYVOU.js";import"./JsonEditor-DSvVl0IO.js";import"./CodeEditor-BFvI7CoV.js";import"./JsonRender-3M2gVJ7Q.js";import"./use-undo.m-Bk1lAah2.js";function _(){const s=T.c(13),[t,h]=f.useState(!1);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],s[0]=r):r=s[0];const[m,u]=f.useState(r);let i;s[1]===Symbol.for("react.memo_cache_sentinel")?(i=[],s[1]=i):i=s[1];const[x,j]=f.useState(i);let o;s[2]===Symbol.for("react.memo_cache_sentinel")?(o=p=>{u(p),h(!0)},s[2]=o):o=s[2];const F=o;let c;s[3]===Symbol.for("react.memo_cache_sentinel")?(c=p=>{console.log("success",p),j(p)},s[3]=c):c=s[3];const y=c;let a;s[4]===Symbol.for("react.memo_cache_sentinel")?(a=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:F}),s[4]=a):a=s[4];let n;s[5]!==t||s[6]!==m?(n=e.jsx(I,{targetType:"list",open:t,list:m,setOpen:h,onSuccess:y}),s[5]=t,s[6]=m,s[7]=n):n=s[7];let l;s[8]!==x?(l=e.jsx(g,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:x}),s[8]=x,s[9]=l):l=s[9];let d;return s[10]!==n||s[11]!==l?(d=e.jsxs("div",{className:"px-4 pb-4",children:[a,n,l]}),s[10]=n,s[11]=l,s[12]=d):d=s[12],d}const v=`import { useState } from 'react'
...
`;function N(){const s=T.c(13),[t,h]=f.useState(!1);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],s[0]=r):r=s[0];const[m,u]=f.useState(r);let i;s[1]===Symbol.for("react.memo_cache_sentinel")?(i=[],s[1]=i):i=s[1];const[x,j]=f.useState(i);let o;s[2]===Symbol.for("react.memo_cache_sentinel")?(o=p=>{u(p),h(!0)},s[2]=o):o=s[2];const F=o;let c;s[3]===Symbol.for("react.memo_cache_sentinel")?(c=p=>{console.log("success",p),j(p)},s[3]=c):c=s[3];const y=c;let a;s[4]===Symbol.for("react.memo_cache_sentinel")?(a=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:F}),s[4]=a):a=s[4];let n;s[5]!==t||s[6]!==m?(n=e.jsx(I,{targetType:"tree",open:t,list:m,setOpen:h,onSuccess:y}),s[5]=t,s[6]=m,s[7]=n):n=s[7];let l;s[8]!==x?(l=e.jsx(g,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:x}),s[8]=x,s[9]=l):l=s[9];let d;return s[10]!==n||s[11]!==l?(d=e.jsxs("div",{className:"px-4 pb-4",children:[a,n,l]}),s[10]=n,s[11]=l,s[12]=d):d=s[12],d}const P=`import { useState } from 'react'
...
`,e.jsx(S,{code:P,title:"上传文件/文件夹（树结构）",description:"选择之后直接上传文件/文件夹，上传成功之后返回文件/文件夹的树结构。",children:e.jsx(N,{})})]})}function E(s={}){const{wrapper:t}={...w(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(D,{...s})}):D(s)}function R(){const s=T.c(13),[t,h]=f.useState(!1);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],s[0]=r):r=s[0];const[m,u]=f.useState(r);let i;s[1]===Symbol.for("react.memo_cache_sentinel")?(i=[],s[1]=i):i=s[1];const[x,j]=f.useState(i);let o;s[2]===Symbol.for("react.memo_cache_sentinel")?(o=p=>{u(p),h(!0)},s[2]=o):o=s[2];const F=o;let c;s[3]===Symbol.for("react.memo_cache_sentinel")?(c=p=>{console.log("success",p),j(p)},s[3]=c):c=s[3];const y=c;let a;s[4]===Symbol.for("react.memo_cache_sentinel")?(a=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:F}),s[4]=a):a=s[4];let n;s[5]!==t||s[6]!==m?(n=e.jsx(I,{targetType:"list",open:t,list:m,setOpen:h,onSuccess:y}),s[5]=t,s[6]=m,s[7]=n):n=s[7];let l;s[8]!==x?(l=e.jsx(g,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:x}),s[8]=x,s[9]=l):l=s[9];let d;return s[10]!==n||s[11]!==l?(d=e.jsxs("div",{className:"px-4 pb-4",children:[a,n,l]}),s[10]=n,s[11]=l,s[12]=d):d=s[12],d}const B=`import { useState } from 'react'
import FilesUploadDrawer, { type UploadFileItemType } from '@/components/FilesUploadDrawer'
import FilesSelect from '@/components/FilesSelect'
import type { FileItemType } from '@/types/files'
import JsonView from '@/components/JsonView'
...
export default FilesListUpload
`;function A(){const s=T.c(13),[t,h]=f.useState(!1);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],s[0]=r):r=s[0];const[m,u]=f.useState(r);let i;s[1]===Symbol.for("react.memo_cache_sentinel")?(i=[],s[1]=i):i=s[1];const[x,j]=f.useState(i);let o;s[2]===Symbol.for("react.memo_cache_sentinel")?(o=p=>{u(p),h(!0)},s[2]=o):o=s[2];const F=o;let c;s[3]===Symbol.for("react.memo_cache_sentinel")?(c=p=>{console.log("success",p),j(p)},s[3]=c):c=s[3];const y=c;let a;s[4]===Symbol.for("react.memo_cache_sentinel")?(a=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:F}),s[4]=a):a=s[4];let n;s[5]!==t||s[6]!==m?(n=e.jsx(I,{targetType:"tree",open:t,list:m,setOpen:h,onSuccess:y}),s[5]=t,s[6]=m,s[7]=n):n=s[7];let l;s[8]!==x?(l=e.jsx(g,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:x}),s[8]=x,s[9]=l):l=s[9];let d;return s[10]!==n||s[11]!==l?(d=e.jsxs("div",{className:"px-4 pb-4",children:[a,n,l]}),s[10]=n,s[11]=l,s[12]=d):d=s[12],d}const C=`import { useState } from 'react'
import FilesUploadDrawer, { type UploadResultFileTreeItemType } from '@/components/FilesUploadDrawer'
import FilesSelect from '@/components/FilesSelect'
import type { FileItemType } from '@/types/files'
import JsonView from '@/components/JsonView'
...
`,e.jsx(S,{code:C,title:"Upload Files/Folders Tree",description:"After selection, directly upload the file/folder. After successful upload, return the tree structure of the file/folder.",children:e.jsx(A,{})})]})}function J(s={}){const{wrapper:t}={...w(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(b,{...s})}):b(s)}function H(){const s=T.c(2),t=L();let h;return s[0]!==t?(h=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(O,{children:t==="zh"?e.jsx(E,{}):e.jsx(J,{})})}),s[0]=t,s[1]=h):h=s[1],h}export{H as default};
