import{c as l,r as i,j as e,a7 as h,a as u}from"./index-sPAEccKG.js";import{u as j,M as g}from"./MDXRender-BZarAgbB.js";import{P as a}from"./Playground-CL5umANt.js";import{J as x}from"./JsonRender-Ct9XYPVU.js";function C(){const s=l.c(3),[n,d]=i.useState(!0);let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=c=>d(c.target.checked),s[0]=r):r=s[0];let t;return s[1]!==n?(t=e.jsxs(e.Fragment,{children:[e.jsx(h,{checked:n,onChange:r,children:"启用代码复制"}),e.jsx(x,{enableCopy:n,className:"mt-2!",children:`{
    "name": "张三",
    "age": 18,
    "gender": "男"
