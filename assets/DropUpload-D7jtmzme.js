import{R as g,j as e,b as m}from"./@uiw/react-codemirror-dimZJgSu.js";import{c as p,a as L}from"./index-Cu686E0i.js";import{M as P}from"./MDXRender-BBvYu2-Q.js";import{D as x}from"./DropElement-CV_ZTvLy.js";import{b as I,F as w}from"./FilesUploadDrawer-g-cQCxDu.js";import{T as E}from"./index-Dn-IxR0R.js";import{J as N}from"./JsonView-WauxlayO.js";import{P as f}from"./Playground-5R6frOv8.js";import{u as j}from"./@mdx-js/react-BwGmxI0N.js";import"./react-syntax-highlighter-DW6ulm9l.js";import"./markdown-plugins-CqPL4kxN.js";import"./react-markdown-U0gPFawi.js";import"./useEffectWithTarget-B17Ot30h.js";import"./isBrowser-xthWFnXw.js";import"./use-immer.module--qy1-jU-.js";import"./index-Cd_Dtwn5.js";import"./progress-BsJPGnFI.js";import"./iconUtil-BMDL6EDQ.js";import"./JsonEditor-B_67iV4Q.js";import"./CodeEditor-CbU2qp3m.js";import"./JsonRender-BAp0alGJ.js";import"./use-undo.m-DcC4Rq-4.js";import"./index-D71U_GTy.js";function b(){const n=p.c(6);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=[],n[0]=t):t=n[0];const[r,d]=g.useState(t);let s;if(n[1]===Symbol.for("react.memo_cache_sentinel")){const o=function(a){console.log("fileTrees",a),d(a)};s=e.jsx(x,{targetType:"tree",onSelect:o,className:"h-30!"}),n[1]=s}else s=n[1];let l;n[2]!==r?(l=r.length>0&&e.jsx(E,{fieldNames:{title:"name",key:"filePath",children:"children"},treeData:r,showLine:!0,defaultExpandAll:!0,height:320,showIcon:!0,icon:S,className:"mt-4 h-80"}),n[2]=r,n[3]=l):l=n[3];let i;return n[4]!==l?(i=e.jsxs(e.Fragment,{children:[s,l]}),n[4]=l,n[5]=i):i=n[5],i}function S(n){return e.jsx(I,{fileName:n.title,type:n.type==="file"?"file":"folder"})}const _=`import React from 'react'
...
`,e.jsx(f,{code:_,title:"文件树",description:"拖拽文件/文件夹到此处，使用文件树查看文件结构。",children:e.jsx(b,{})}),`
