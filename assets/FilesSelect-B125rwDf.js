import{c as m,r as a,j as e,u as T}from"./index-CIGk9ZnJ.js";import{u as j,M as g}from"./MDXRender-D9plMhjo.js";import{P as p}from"./Playground-BNwi_gF4.js";import{F as y}from"./FilesUploadDrawer-CAzdWzVU.js";import{F as x}from"./FilesSelect-D4xqUsCv.js";import{J as f}from"./JsonView-C7Lw0-dA.js";import"./JsonEditor-DY1ovXTU.js";import"./CodeEditor-DvkJBADL.js";import"./JsonRender-COIaxv0w.js";import"./use-undo.m-B9bhx3J_.js";function I(){const n=m.c(6),[t,s]=a.useState(!1);let r;n[0]===Symbol.for("react.memo_cache_sentinel")?(r=[],n[0]=r):r=n[0];const[l,i]=a.useState(r);let o;n[1]===Symbol.for("react.memo_cache_sentinel")?(o=F=>{i(F),s(!0)},n[1]=o):o=n[1];const d=o;let c;n[2]===Symbol.for("react.memo_cache_sentinel")?(c=e.jsx(x,{targetType:"list",isUpload:!0,onSelect:d}),n[2]=c):c=n[2];let h;return n[3]!==t||n[4]!==l?(h=e.jsxs("div",{className:"px-4 pb-4",children:[c,e.jsx(y,{targetType:"list",open:t,list:l,setOpen:s})]}),n[3]=t,n[4]=l,n[5]=h):h=n[5],h}const L=`import { useState } from 'react'
