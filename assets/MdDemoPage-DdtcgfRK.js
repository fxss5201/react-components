import{b as v,j as e}from"./@uiw/react-codemirror-dimZJgSu.js";import{c as E,a as P,X as L,Y as N}from"./index-DSuvab2R.js";import{P as T}from"./Playground-DMhcnxEs.js";import{u as R}from"./index-D6hL_xQQ.js";import{C as D}from"./CodeEditor-CQiUGbj3.js";import{S as x}from"./index-CmIft-A4.js";import"./react-syntax-highlighter-DW6ulm9l.js";import"./markdown-plugins-CqPL4kxN.js";import"./react-markdown-U0gPFawi.js";import"./UpOutlined-DGt0aSTq.js";const y=`# 这是一个 Markdown 页面
...
`;function X(){const n=E.c(4),o=P(),t=o==="zh"?"Markdown 演示示例":"Markdown Demo",d=o==="zh"?"Markdown 组件的演示示例，展示了如何使用 Markdown 组件渲染 Markdown 内容。":"Demo of Markdown component, showing how to use Markdown component to render Markdown content.";let a;n[0]===Symbol.for("react.memo_cache_sentinel")?(a=e.jsx(I,{}),n[0]=a):a=n[0];let r;return n[1]!==t||n[2]!==d?(r=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(T,{code:O,title:t,description:d,children:a})}),n[1]=t,n[2]=d,n[3]=r):r=n[3],r}export{X as default};
