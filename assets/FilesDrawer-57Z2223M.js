import{c as O,r as x,j as e,u as R,A,S as N,B as _,a as V}from"./index-sPAEccKG.js";import{u as v,M as J}from"./MDXRender-BZarAgbB.js";import{P}from"./Playground-CL5umANt.js";import{F as C,a as $}from"./FilesUploadDrawer-eKFMY6t7.js";import{F as U}from"./FilesDropSelect-uTwU63Xo.js";import{J as b}from"./JsonView-BGQFDy7V.js";import"./DropElement-D51bjCMN.js";import"./useEffectWithTarget-BuQwNup2.js";import"./FilesSelect-D7M6weG2.js";import"./JsonEditor-BoNEgsyL.js";import"./CodeEditor-iUaEkS4k.js";import"./JsonRender-Ct9XYPVU.js";import"./use-undo.m-Du7Ehewq.js";function M(){const t=O.c(13),[n,p]=x.useState(!1);let i;t[0]===Symbol.for("react.memo_cache_sentinel")?(i=[],t[0]=i):i=t[0];const[a,f]=x.useState(i);let d;t[1]===Symbol.for("react.memo_cache_sentinel")?(d=[],t[1]=d):d=t[1];const[h,D]=x.useState(d);let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=c=>{f(c),p(!0)},t[2]=u):u=t[2];const w=u;let m;t[3]===Symbol.for("react.memo_cache_sentinel")?(m=c=>{console.log("success",c),D(c)},t[3]=m):m=t[3];const F=m;let o;t[4]===Symbol.for("react.memo_cache_sentinel")?(o=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:w}),t[4]=o):o=t[4];let r;t[5]!==n||t[6]!==a?(r=e.jsx(C,{targetType:"list",title:"上传文件/文件夹",open:n,list:a,setOpen:p,onSuccess:F}),t[5]=n,t[6]=a,t[7]=r):r=t[7];let l;t[8]!==h?(l=e.jsx(b,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:h}),t[8]=h,t[9]=l):l=t[9];let s;return t[10]!==r||t[11]!==l?(s=e.jsxs("div",{className:"px-4 pb-4",children:[o,r,l]}),t[10]=r,t[11]=l,t[12]=s):s=t[12],s}const W=`import { useState } from 'react'
...
`;function X(){const t=O.c(13),[n,p]=x.useState(!1);let i;t[0]===Symbol.for("react.memo_cache_sentinel")?(i=[],t[0]=i):i=t[0];const[a,f]=x.useState(i);let d;t[1]===Symbol.for("react.memo_cache_sentinel")?(d=[],t[1]=d):d=t[1];const[h,D]=x.useState(d);let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=c=>{f(c),p(!0)},t[2]=u):u=t[2];const w=u;let m;t[3]===Symbol.for("react.memo_cache_sentinel")?(m=c=>{console.log("success",c),D(c)},t[3]=m):m=t[3];const F=m;let o;t[4]===Symbol.for("react.memo_cache_sentinel")?(o=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:w}),t[4]=o):o=t[4];let r;t[5]!==n||t[6]!==a?(r=e.jsx(C,{targetType:"tree",title:"上传文件/文件夹",open:n,list:a,setOpen:p,onSuccess:F}),t[5]=n,t[6]=a,t[7]=r):r=t[7];let l;t[8]!==h?(l=e.jsx(b,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:h}),t[8]=h,t[9]=l):l=t[9];let s;return t[10]!==r||t[11]!==l?(s=e.jsxs("div",{className:"px-4 pb-4",children:[o,r,l]}),t[10]=r,t[11]=l,t[12]=s):s=t[12],s}const G=`import { useState } from 'react'
import FilesUploadDrawer from '@/components/FilesUploadDrawer'
...
`,B="/react-components/assets/FilesDrawer-whdMZwxM.png";function K(t){const n=document.createElement("a");n.href=t;const p={protocol:window.location.protocol,host:window.location.hostname,port:window.location.port||(window.location.protocol==="https:"?"443":"80")},i={protocol:n.protocol,host:n.hostname,port:n.port||(n.protocol==="https:"?"443":"80")},a=p.protocol===i.protocol,f=p.host===i.host,d=p.port===i.port;return!(a&&f&&d)}function H({targetType:t="list",title:n="下载文件/文件夹",open:p=!1,setOpen:i,list:a=[],onSuccess:f,isSelectFolder:d=!0}){const{t:h}=R(),{message:D}=A.useApp(),[u,w]=x.useState(p),[m,F]=x.useState(d);x.useEffect(()=>{F(d)},[d]);const o=x.useRef(null);x.useEffect(()=>(p?d?(async()=>{if(!window.showDirectoryPicker){D.warning(h("components.FilesDownloadDrawer.noSupport",{defaultValue:"当前浏览器不支持选择文件夹，将使用普通下载"})),F(!1),w(!0);return}try{const s=await window.showDirectoryPicker({mode:"readwrite",id:"FilesDownloadDrawer"});if(!s)return;o.current=s,w(!0)}catch(s){i(!1),s instanceof Error&&s.message.includes("aborted")?D.warning(h("components.FilesDownloadDrawer.chooseFolder",{defaultValue:"请选择文件夹"})):console.log("🚀 ~ selectDirectoryStoreFn ~ error:",s)}})():w(!0):w(!1),()=>{o.current=null}),[p,d,h,D,i]);const r=x.useCallback(async l=>{const s=async j=>{try{const y=await fetch(j);if(!y.ok)throw new Error(`error: ${y.status} ${y.statusText}`);return await y.blob()}catch(y){throw new Error(`download error: ${y}`)}},c=async j=>{if(o.current)if(j.folderPath==="/"){const S=await(await o.current.getFileHandle(j.name,{create:!0})).createWritable();await S.write(await s(j.url)),await S.close()}else{const y=j.folderPath.split("/").filter(L=>L!=="");let S=o.current;for(const L of y)S=await S.getDirectoryHandle(L,{create:!0});const I=await(await S.getFileHandle(j.name,{create:!0})).createWritable();await I.write(await s(j.url)),await I.close()}},g=async j=>{console.log("downloadFile",j);const y=K(j.url);let S=j.url;if(y){const I=await s(j.url);S=URL.createObjectURL(I)}const T=document.createElement("a");T.href=S,T.target="_blank",T.download=j.name,document.body.appendChild(T),T.click(),document.body.removeChild(T),y&&URL.revokeObjectURL(S)};l.url&&(m?await c(l):await g(l))},[m]);return e.jsx($,{targetType:t,title:n,open:u,setOpen:i,list:a,doneFile:r,onSuccess:f})}function Y(){const t=O.c(22),[n,p]=x.useState(!1);let i;t[0]===Symbol.for("react.memo_cache_sentinel")?(i=[{name:"vite.svg",type:"file",filePath:"/vite.svg",folderPath:"/",url:"/react-components/vite.svg"},{name:"logo123.png",type:"file",filePath:"/logo123.png",folderPath:"/",url:"https://blog.fxss.work/logo123.png"},{name:"logo.png",type:"file",filePath:"/logo.png",folderPath:"/",url:"https://blog.fxss.work/logo.png"},{name:"aaa.png",type:"file",filePath:"/dir/bb/aaa.png",folderPath:"/dir/bb",url:"https://vkceyugu.cdn.bspapp.com/VKCEYUGU-f80fb055-eaa7-4008-b0c3-05194e370800/26671f33-7f69-40e8-af57-cc66a8d437cf.png"}],t[0]=i):i=t[0];const[a]=x.useState(i),[f,d]=x.useState(!0);let h;t[1]===Symbol.for("react.memo_cache_sentinel")?(h=[],t[1]=h):h=t[1];const[D,u]=x.useState(h);let w;t[2]===Symbol.for("react.memo_cache_sentinel")?(w=y=>{console.log("success",y),u(y)},t[2]=w):w=t[2];const m=w;let F;t[3]===Symbol.for("react.memo_cache_sentinel")?(F=e.jsx("div",{className:"mb-4!",children:"网络内容："}),t[3]=F):F=t[3];let o;t[4]!==a?(o=e.jsx(b,{className:"mb-4!",jsonClassName:"max-h-100 overflow-auto",children:a}),t[4]=a,t[5]=o):o=t[5];let r;t[6]!==f?(r=e.jsx(N,{checkedChildren:"文件夹下载",unCheckedChildren:"普通下载",checked:f,onChange:d}),t[6]=f,t[7]=r):r=t[7];let l;t[8]===Symbol.for("react.memo_cache_sentinel")?(l=e.jsx(_,{onClick:()=>p(!0),className:"ml-4",children:"下载文件/文件夹"}),t[8]=l):l=t[8];let s;t[9]!==r?(s=e.jsxs("div",{className:"flex items-center",children:[r,l]}),t[9]=r,t[10]=s):s=t[10];let c;t[11]!==n||t[12]!==a||t[13]!==f?(c=e.jsx(H,{targetType:"list",title:"下载文件/文件夹",open:n,list:a,setOpen:p,onSuccess:m,isSelectFolder:f}),t[11]=n,t[12]=a,t[13]=f,t[14]=c):c=t[14];let g;t[15]!==D?(g=e.jsx(b,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:D}),t[15]=D,t[16]=g):g=t[16];let j;return t[17]!==o||t[18]!==s||t[19]!==c||t[20]!==g?(j=e.jsxs(e.Fragment,{children:[F,o,s,c,g]}),t[17]=o,t[18]=s,t[19]=c,t[20]=g,t[21]=j):j=t[21],j}const z=`import { useState } from 'react'
...
`;function k(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...v(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"filesdrawer",children:"FilesDrawer"}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"FilesDrawer"})," 组件是视图抽象层，提供样式和内部逻辑，可以用于文件/文件夹的上传、下载、压缩等，样式如下："]}),`
`,e.jsx("img",{src:B,alt:"FilesDrawer"}),`
...
`,e.jsx(P,{code:W,title:"上传文件/文件夹",description:"选择之后直接上传文件/文件夹，上传成功之后返回文件/文件夹的列表结构。",children:e.jsx(M,{})}),`
`,e.jsx(n.h4,{id:"上传文件文件夹树结构",children:"上传文件/文件夹（树结构）"}),`
`,e.jsx(P,{code:G,title:"上传文件/文件夹（树结构）",description:"选择之后直接上传文件/文件夹，上传成功之后返回文件/文件夹的树结构。",children:e.jsx(X,{})}),`
...
`,e.jsx(P,{code:z,title:"下载文件/文件夹",description:"选择文件夹下载或者普通下载，查看下载效果。",children:e.jsx(Y,{})})]})}function Z(t={}){const{wrapper:n}={...v(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(k,{...t})}):k(t)}function q(){const t=O.c(13),[n,p]=x.useState(!1);let i;t[0]===Symbol.for("react.memo_cache_sentinel")?(i=[],t[0]=i):i=t[0];const[a,f]=x.useState(i);let d;t[1]===Symbol.for("react.memo_cache_sentinel")?(d=[],t[1]=d):d=t[1];const[h,D]=x.useState(d);let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=c=>{f(c),p(!0)},t[2]=u):u=t[2];const w=u;let m;t[3]===Symbol.for("react.memo_cache_sentinel")?(m=c=>{console.log("success",c),D(c)},t[3]=m):m=t[3];const F=m;let o;t[4]===Symbol.for("react.memo_cache_sentinel")?(o=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:w}),t[4]=o):o=t[4];let r;t[5]!==n||t[6]!==a?(r=e.jsx(C,{targetType:"list",title:"Upload Files/Folders",open:n,list:a,setOpen:p,onSuccess:F}),t[5]=n,t[6]=a,t[7]=r):r=t[7];let l;t[8]!==h?(l=e.jsx(b,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:h}),t[8]=h,t[9]=l):l=t[9];let s;return t[10]!==r||t[11]!==l?(s=e.jsxs("div",{className:"px-4 pb-4",children:[o,r,l]}),t[10]=r,t[11]=l,t[12]=s):s=t[12],s}const Q=`import { useState } from 'react'
import FilesUploadDrawer from '@/components/FilesUploadDrawer'
import { type DrawerFileItemType } from '@/components/FilesDrawer'
import FilesDropSelect from '@/components/FilesDropSelect'
import type { FileItemType } from '@/types/files'
...
export default FilesListUpload
`;function ee(){const t=O.c(13),[n,p]=x.useState(!1);let i;t[0]===Symbol.for("react.memo_cache_sentinel")?(i=[],t[0]=i):i=t[0];const[a,f]=x.useState(i);let d;t[1]===Symbol.for("react.memo_cache_sentinel")?(d=[],t[1]=d):d=t[1];const[h,D]=x.useState(d);let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=c=>{f(c),p(!0)},t[2]=u):u=t[2];const w=u;let m;t[3]===Symbol.for("react.memo_cache_sentinel")?(m=c=>{console.log("success",c),D(c)},t[3]=m):m=t[3];const F=m;let o;t[4]===Symbol.for("react.memo_cache_sentinel")?(o=e.jsx(U,{targetType:"list",isUpload:!0,onSelect:w}),t[4]=o):o=t[4];let r;t[5]!==n||t[6]!==a?(r=e.jsx(C,{targetType:"tree",title:"Upload Files/Folders",open:n,list:a,setOpen:p,onSuccess:F}),t[5]=n,t[6]=a,t[7]=r):r=t[7];let l;t[8]!==h?(l=e.jsx(b,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:h}),t[8]=h,t[9]=l):l=t[9];let s;return t[10]!==r||t[11]!==l?(s=e.jsxs("div",{className:"px-4 pb-4",children:[o,r,l]}),t[10]=r,t[11]=l,t[12]=s):s=t[12],s}const ne=`import { useState } from 'react'
import FilesUploadDrawer from '@/components/FilesUploadDrawer'
import { type DrawerResultFileTreeItemType } from '@/components/FilesDrawer'
import FilesDropSelect from '@/components/FilesDropSelect'
import type { FileItemType } from '@/types/files'
...
export default FilesListUploadTree
`;function te(){const t=O.c(22),[n,p]=x.useState(!1);let i;t[0]===Symbol.for("react.memo_cache_sentinel")?(i=[{name:"vite.svg",type:"file",filePath:"/vite.svg",folderPath:"/",url:"/react-components/vite.svg"},{name:"logo123.png",type:"file",filePath:"/logo123.png",folderPath:"/",url:"https://blog.fxss.work/logo123.png"},{name:"logo.png",type:"file",filePath:"/logo.png",folderPath:"/",url:"https://blog.fxss.work/logo.png"},{name:"aaa.png",type:"file",filePath:"/dir/bb/aaa.png",folderPath:"/dir/bb",url:"https://vkceyugu.cdn.bspapp.com/VKCEYUGU-f80fb055-eaa7-4008-b0c3-05194e370800/26671f33-7f69-40e8-af57-cc66a8d437cf.png"}],t[0]=i):i=t[0];const[a]=x.useState(i),[f,d]=x.useState(!0);let h;t[1]===Symbol.for("react.memo_cache_sentinel")?(h=[],t[1]=h):h=t[1];const[D,u]=x.useState(h);let w;t[2]===Symbol.for("react.memo_cache_sentinel")?(w=y=>{console.log("success",y),u(y)},t[2]=w):w=t[2];const m=w;let F;t[3]===Symbol.for("react.memo_cache_sentinel")?(F=e.jsx("div",{className:"mb-4!",children:"Network Content:"}),t[3]=F):F=t[3];let o;t[4]!==a?(o=e.jsx(b,{className:"mb-4!",jsonClassName:"max-h-100 overflow-auto",children:a}),t[4]=a,t[5]=o):o=t[5];let r;t[6]!==f?(r=e.jsx(N,{checkedChildren:"Folder Download",unCheckedChildren:"Normal Download",checked:f,onChange:d}),t[6]=f,t[7]=r):r=t[7];let l;t[8]===Symbol.for("react.memo_cache_sentinel")?(l=e.jsx(_,{onClick:()=>p(!0),className:"ml-4",children:"Download Files/Folders"}),t[8]=l):l=t[8];let s;t[9]!==r?(s=e.jsxs("div",{className:"flex items-center",children:[r,l]}),t[9]=r,t[10]=s):s=t[10];let c;t[11]!==n||t[12]!==a||t[13]!==f?(c=e.jsx(H,{targetType:"list",title:"Download Files/Folders",open:n,list:a,setOpen:p,onSuccess:m,isSelectFolder:f}),t[11]=n,t[12]=a,t[13]=f,t[14]=c):c=t[14];let g;t[15]!==D?(g=e.jsx(b,{className:"mt-4!",jsonClassName:"max-h-100 overflow-auto",children:D}),t[15]=D,t[16]=g):g=t[16];let j;return t[17]!==o||t[18]!==s||t[19]!==c||t[20]!==g?(j=e.jsxs(e.Fragment,{children:[F,o,s,c,g]}),t[17]=o,t[18]=s,t[19]=c,t[20]=g,t[21]=j):j=t[21],j}const se=`import { useState } from 'react'
import FilesDownloadDrawer from '@/components/FilesDownloadDrawer'
import { type DrawerFileItemType } from '@/components/FilesDrawer'
import type { FileDownloadItemType } from '@/types/files'
import JsonView from '@/components/JsonView'
...
export default FilesDownload
`;function E(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...v(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"filesdrawer",children:"FilesDrawer"}),`
...
`,e.jsx(P,{code:Q,title:"Upload Files/Folders",description:"After selection, directly upload the file/folder. After successful upload, return the list structure of the file/folder.",children:e.jsx(q,{})}),`
`,e.jsx(n.h4,{id:"upload-filesfolders-tree",children:"Upload Files/Folders Tree"}),`
`,e.jsx(P,{code:ne,title:"Upload Files/Folders Tree",description:"After selection, directly upload the file/folder. After successful upload, return the tree structure of the file/folder.",children:e.jsx(ee,{})}),`
`,e.jsx(n.h3,{id:"filesdownloaddrawer",children:"FilesDownloadDrawer"}),`
...
`,e.jsx(P,{code:se,title:"Download Files/Folders",description:"Select folder download or normal download, and view the download effect.",children:e.jsx(te,{})})]})}function re(t={}){const{wrapper:n}={...v(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(E,{...t})}):E(t)}function we(){const t=O.c(2),n=V();let p;return t[0]!==n?(p=e.jsx("div",{className:"px-4 pb-4",children:e.jsx(J,{children:n==="zh"?e.jsx(Z,{}):e.jsx(re,{})})}),t[0]=n,t[1]=p):p=t[1],p}export{we as default};
