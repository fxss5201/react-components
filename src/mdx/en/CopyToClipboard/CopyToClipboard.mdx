...
import CopyToClipboardChildren from './CopyToClipboardChildren'
import CopyToClipboardChildrenRaw from './CopyToClipboardChildren.tsx?raw'
...
| `children` | Child elements, used to customize the appearance of the copy button, [children description](#children-description) | `React.ReactNode \| ((props: { copied: boolean, copyToClipboard: () => void }) => React.ReactNode)` | [children default value](#children-default-value) |
...
<Playground code={CopyToClipboardChildrenRaw} title='Custom Copy Button' description='Enter content in the text box and click the custom copy button to copy to the clipboard.'>
